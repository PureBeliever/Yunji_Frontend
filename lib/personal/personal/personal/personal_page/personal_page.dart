...
//请求用户个人资料
  void requestUserPersonalInformationDataOnTheBackEnd(
    ...
    if (userPersonalInformationData['like_list'] != null) {
      ...
      userLikedMemoryBank =
          await queryUserPersonalMemoryBank(userLikedMemoryBankIndexint);
    }
    ...
    if (userPersonalInformationData['pull_list'] != null) {
      ...
      userPulledMemoryBank =
          await queryUserPersonalMemoryBank(userPulledMemoryBankIndexint);
    }
    ...
    if (userPersonalInformationData['review_list'] != null) {
      ...
      userReviewMemoryBank =
          await queryUserPersonalMemoryBank(userReviewMemoryBankIndexint);
    }
